...
const primaryBtn: React.CSSProperties = { ...btn(), background: 'var(--dsw-alias-brand-primary)', color: '#fff', borderColor: 'transparent' }
    ...
    <div style={{ padding: 16, maxWidth: 640 }}>
      <div style={wrap}>
        ...
        <div style={body}>
          {/* ---- identity & discovery ---- */}
          <div style={group}>
            <div style={groupTitle}><span>🪪</span>{t('settings.discoveryTitle')}</div>
          ...
          {/* ---- communication ---- */}
          <div style={group}>
            <div style={groupTitle}><span>🌐</span>{t('settings.communicationTitle')}</div>
          ...
          {/* ---- reply engine ---- */}
          <div style={group}>
            <div style={groupTitle}><span>🤖</span>{t('settings.replyTitle')}</div>
            ...
            <div style={{ display: 'flex', gap: 8, marginTop: 2 }}>
              <input className="p2p-field" style={fieldInline} value={config.provider} placeholder={t('settings.providerPlaceholder')} onChange={(event) => { patch({ provider: event.currentTarget.value }) }} />
              <input className="p2p-field" style={fieldInline} value={config.model} placeholder={t('settings.modelPlaceholder')} onChange={(event) => { patch({ model: event.currentTarget.value }) }} />
            </div>
          ...
          {/* ---- projects ---- */}
          <div style={group}>
            <div style={groupTitle}><span>📁</span>{t('settings.projectsTitle')}</div>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginTop: 14 }}>
              ...
              {saved === 'ok' ? <span style={{ fontSize: 12, color: 'var(--dsw-alias-state-success-primary)' }}>✓ {t('settings.saved')}</span> : null}
          ...
          {/* ---- debug ---- */}
          <div style={group}>
            <div style={groupTitle}><span>🐞</span>{t('settings.debug')}</div>
            <label style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 12, color: 'var(--dsw-alias-label-secondary)', marginTop: 4 }}>
